...
class SiputProvider {
    ...
    async connect() {
        try {
            ...
            throw new Error(`Failed to connect to Siput node: ${error.message}`);
        }
    }
    ...
    connectWebSocket() {
        try {
            ...
            this.wsConnection.onopen = () => {
                console.log('Connected to Siput WebSocket');
            };
...
if (typeof module !== 'undefined' && module.exports) {
    // Node.js
    module.exports = SiputProvider;
} else if (typeof define === 'function' && define.amd) {
    // AMD
    define([], function() { return SiputProvider; });
} else if (typeof window !== 'undefined') {
    // Browser global
    window.SiputProvider = SiputProvider;
}