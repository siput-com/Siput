...
impl DAGIndex {
    ...
    pub fn get_all_descendants(&self, hash: &BlockHash, _store: &BlockStore) -> HashSet<BlockHash> {
    ...
    pub fn get_all_ancestors(&self, hash: &BlockHash, store: &BlockStore) -> HashSet<BlockHash> {
