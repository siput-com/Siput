/// Configuration loader untuk Siput node
    ...
    fn default() -> Self {
        Self {
            ...
            node: NodeSettings {
                ...
                node_name: "siput-node".to_string(),
                enable_rpc: true,
            },
        }
    }
...
impl NodeConfig {
    ...
    pub fn print_summary(&self) {
        println!("\n╔════════════════════════════════════════════╗");
        println!("║ Siput Node Configuration             ║");
        println!("╚════════════════════════════════════════════╝");
        println!("\n[Network]");
        ...
        println!(
            ...
            self.consensus.confirmation_depth
        );
        ...
        println!(
            ...
            self.sync.periodic_check_interval
        );
