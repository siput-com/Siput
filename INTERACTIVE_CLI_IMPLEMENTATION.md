INTERACTIVE CLI IMPLEMENTATION – SIPUT

Objective

Refactor the current CLI command-based interface into an interactive numeric menu system.

The CLI must allow users to run Siput features by pressing numbers + Enter.
            ...
            - Miner
              - WalletManager
                - TxExecutor
                  ...
                  - User can fully operate Siput node using only numeric input.
